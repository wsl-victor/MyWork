...
- (void)updateLocationToServer {
    ...
    //TODO: Your code to send the self.myLocation and self.myLocationAccuracy to your server
        ...
        dict[@"latitude"]=[NSNumber numberWithFloat:self.myLocation.latitude];
        dict[@"longitude"]=[NSNumber numberWithFloat:self.myLocation.longitude];
        dict[@"coord_type"]=@1;
        ...
        [MDJHttpTool post:cretateTrack params:dict success:^(id responseObj) {
            NSLog(@"＝＝＝cretateTrack＝＝成功了");
        } failure:^(NSError *error) {
            NSLog(@"＝＝＝cretateTrack＝＝失败了");
        }];
